...
export default function CreateOrganizationStep3Page() {
  ...
  return (
    <CreateOrganizationLayout currentStep={3} className="space-y-3">
      <div>
      ...
      <div className="space-y-3">
        <Button variant="outline" onClick={() => setUsersOpen((prev) => !prev)}>
          <ChevronDown
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Button
                    variant="link"
                    className="gap-0 px-0!"
                    onClick={() => handleAddInvitedUser(InviteUserRole.USER)}
                  >
                    <Plus className="size-4!" />
                    <span>Add another manager</span>
                  </Button>
