import { Hourglass, Monitor, Timer } from "lucide-react";
    ...
    links: [
      {
        ...
        icon: Hourglass,
        description: "Set the inactivity time before users are marked as idle.",
      },
      // {
      //   id: "1",
      //   label: "Custom fields",
    ...
    links: [
      {
        ...
        icon: Timer,
        description:
          "Set how often screenshots are captured during active sessions.",
      },
      {
        id: "2",
        ...
        href: "/dashboard/admin/settings/activity-tracking",
        icon: Monitor,
        description: "Turn screenshot capturing on or off for employees.",
      },
    ],
  },
  // {
